...
public enum ErrorCode {
    ...
    USERNAME_INVALID(1003, "Username must be at 3 characters", HttpStatus.BAD_REQUEST),
    PASSWORD_INVALID(1004, "Password must be at 8 characters", HttpStatus.BAD_REQUEST),
